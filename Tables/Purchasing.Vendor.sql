...
GO
ALTER TABLE [Purchasing].[Vendor] ADD CONSTRAINT [PK_Vendor_VendorID] PRIMARY KEY CLUSTERED  ([VendorID]) ON [PRIMARY]
GO
...
GO
EXEC sp_addextendedproperty N'MS_Description', N'Primary key for Vendor records.', 'SCHEMA', N'Purchasing', 'TABLE', N'Vendor', 'COLUMN', N'VendorID'
GO
...
GO
EXEC sp_addextendedproperty N'MS_Description', N'Primary key (clustered) constraint', 'SCHEMA', N'Purchasing', 'TABLE', N'Vendor', 'CONSTRAINT', N'PK_Vendor_VendorID'
GO
...
GO
EXEC sp_addextendedproperty N'MS_Description', N'Clustered index created by a primary key constraint.', 'SCHEMA', N'Purchasing', 'TABLE', N'Vendor', 'INDEX', N'PK_Vendor_VendorID'
GO
