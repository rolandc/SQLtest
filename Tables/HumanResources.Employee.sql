...
GO
CREATE NONCLUSTERED INDEX [IX_Employee_ManagerID] ON [HumanResources].[Employee] ([ManagerID]) ON [PRIMARY]
GO
...
GO
ALTER TABLE [HumanResources].[Employee] ADD CONSTRAINT [FK_Employee_Employee_ManagerID] FOREIGN KEY ([ManagerID]) REFERENCES [HumanResources].[Employee] ([EmployeeID])
GO
...
GO
EXEC sp_addextendedproperty N'MS_Description', N'Identifies the employee in the Contact table. Foreign key to Contact.ContactID.', 'SCHEMA', N'HumanResources', 'TABLE', N'Employee', 'COLUMN', N'ContactID'
GO
...
GO
EXEC sp_addextendedproperty N'MS_Description', N'Primary key for Employee records.', 'SCHEMA', N'HumanResources', 'TABLE', N'Employee', 'COLUMN', N'EmployeeID'
GO
...
GO
EXEC sp_addextendedproperty N'MS_Description', N'Manager to whom the employee is assigned. Foreign Key to Employee.M', 'SCHEMA', N'HumanResources', 'TABLE', N'Employee', 'COLUMN', N'ManagerID'
GO
...
GO
EXEC sp_addextendedproperty N'MS_Description', N'Work title such as Buyer or Sales Representative.', 'SCHEMA', N'HumanResources', 'TABLE', N'Employee', 'COLUMN', N'Title'
GO
...
GO
EXEC sp_addextendedproperty N'MS_Description', N'Foreign key constraint referencing Contact.ContactID.', 'SCHEMA', N'HumanResources', 'TABLE', N'Employee', 'CONSTRAINT', N'FK_Employee_Contact_ContactID'
GO
EXEC sp_addextendedproperty N'MS_Description', N'Foreign key constraint referencing Employee.ManagerID.', 'SCHEMA', N'HumanResources', 'TABLE', N'Employee', 'CONSTRAINT', N'FK_Employee_Employee_ManagerID'
GO
EXEC sp_addextendedproperty N'MS_Description', N'Primary key (clustered) constraint', 'SCHEMA', N'HumanResources', 'TABLE', N'Employee', 'CONSTRAINT', N'PK_Employee_EmployeeID'
GO
...
GO
EXEC sp_addextendedproperty N'MS_Description', N'Nonclustered index.', 'SCHEMA', N'HumanResources', 'TABLE', N'Employee', 'INDEX', N'IX_Employee_ManagerID'
GO
EXEC sp_addextendedproperty N'MS_Description', N'Clustered index created by a primary key constraint.', 'SCHEMA', N'HumanResources', 'TABLE', N'Employee', 'INDEX', N'PK_Employee_EmployeeID'
GO
