...
GO
EXEC sp_addextendedproperty N'MS_Description', N'Lookup table containing the types of contacts stored in Contact.', 'SCHEMA', N'Person', 'TABLE', N'ContactType', NULL, NULL
GO
