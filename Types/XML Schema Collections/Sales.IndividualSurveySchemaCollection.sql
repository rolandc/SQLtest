CREATE XML SCHEMA COLLECTION [Sales].[IndividualSurveySchemaCollection] 
...
GO
EXEC sp_addextendedproperty N'MS_Description', N'Collection of XML schemas for the Demographics column in the Sales.Individual table.', 'SCHEMA', N'Sales', 'XML SCHEMA COLLECTION', N'IndividualSurveySchemaCollection', NULL, NULL
GO
